...
<%--	                            	</c:forEach>--%>
	                            ...
	                            <td>
	                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateRole.do?id=${role.id }';"/>
                ...
                <div id="pages">
                	<c:choose>
                		...
                		<c:otherwise>
                			<a href="/role/findRoleList.do?currentPage=${rolePage.currentPage-1 }">上一页</a>
                		</c:otherwise>
                	</c:choose>
        	        ...
        	        <c:forEach begin="1" end="${rolePage.totalPage }" var="p">
        	        	<c:choose>
        	        		<c:when test="${p==rolePage.currentPage }">
        	        			<a href="findRoleList.do?currentPage=${p }" class="current_page">${p }</a>
        	        		</c:when>
        	        		<c:otherwise>
        	        			<a href="findRoleList.do?currentPage=${p }">${p }</a>
        	        		</c:otherwise>
        	        	</c:choose>
                    </c:forEach>
                    ...
                    <c:choose>
                		...
                		<c:otherwise>
                			<a href="findRoleList.do?currentPage=${rolePage.currentPage+1 }">下一页</a>
                		</c:otherwise>
                	</c:choose>
                </div>
            </form>
